...
public class TestField {
    ...
    public void getAnnotation() throws ClassNotFoundException {
        ...
        boolean isEmpty = stu.isAnnotationPresent(FieldMeta.class);//判断stu是不是使用了我们刚才定义的注解接口if(isEmpty){
        ...
        {
            boolean ismEmpty = m.isAnnotationPresent(FieldMeta.class);
            if (ismEmpty) {
